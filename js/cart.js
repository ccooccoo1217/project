;(function(){
	...
	$.ajax({
	    ...
	    for (var i = 39; i < 43; i++) {
	        $html += '<li>' +
	            '<div class="goodsinfo">' +
	            '<div class="p-img">' +
	            '<a href="##"><img class="loadimg" src="' + data[i].url + '" alt="" sid="' + data[i].id + '" /></a>' +
	            '</div>' +
	            '<div class="p-name">' +
	...
	$(function() {
		if(getCookie('UserName')) {
			$('#head .right a').eq(8).html(getCookie('UserName'));
		}
	});
})();
